...
trait DomUtility
{
    ...
    public function loadFile($filename, $options = 0): bool
    {
    ...
    public function loadHTML($html, $options = 0): bool
    {
        ...
        // Use libxml options to suppress errors and handle HTML5
        $options = $options | LIBXML_HTML_NOIMPLIED | LIBXML_NOERROR | LIBXML_HTML_NODEFDTD | LIBXML_NOWARNING;
...
$html = preg_replace('/<meta[^>]*>/i', '', $html);
    ...
    */
    ...
    $tempDoc->loadHTML('<div>' . $html . '</div>', LIBXML_HTML_NOIMPLIED | LIBXML_HTML_NODEFDTD | LIBXML_NOERROR |
    LIBXML_NOWARNING);
